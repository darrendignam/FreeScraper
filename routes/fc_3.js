...
This is a useful version of the script that lets you pass in an address in the querystring that will then get scraped for you.
This is used for some of the queries on the index route :)
...
router.get('/', function(req, res) {
  ...
  //processed link ;)
  var processed_link = "/posts/offer?page=1&resultsperpage=50&showall=off&include_offers=off&include_wanteds=off&include_receiveds=off&include_takens=off";
  //get the top 100 offers right now! :)

  processed_link = req.query.target + processed_link;
  //lets you choose a page to look at using a query string ?target=FREECYCLEPAGE
